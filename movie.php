        ...
        <div class="comments">
            ...
            <div class="comments-collection">
                <div class="user-comment">
                    <?php
                    if (isset($_SESSION["user"]["id"]) && $kol > 0) {
                    ?>
                        <h3>Ваш комментарии</h3>
                        <?php
                        ...
                        <div class="comment" data-id=<?= $commentuser ?>>
                            ...
                            <?php
                            if (isset($_SESSION["user"]["id"]) && $user_comment["user_id"] == $userid) {
                            ?>
                                <div class="buttons">
                    ...
                    <? } else { ?>
                        ...
                        <form action="php/sendComment" class="send-comment" method="post">
                            ...
                            <?php if (isset($_SESSION["message"])) { ?>
                                <span
                                    style="color: red; font-weight: 500; text-align: center"><?= $_SESSION["message"] ?></span>
                ...
                <?php
                if (isset($_SESSION["user"]["id"]) && (isset($kol) && $kol != 0) && pg_num_rows($comments) - 1 > 0) {
                ?>
                ...
                while ($row = pg_fetch_assoc($comments)) {
                    ...
                    if (
                        (isset($_SESSION["user"]) && isset($_SESSION["user"]["id"]) && $row["user_id"] != $userid) ||
                        (!isset($_SESSION["user"]) || !isset($_SESSION["user"]["id"]) && $row["user_id"] == $userid)
                    ) {
                    ?>
