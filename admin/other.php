            ...
            <div class="data-collection">
                <div class="data">
                    ...
                    <div class="table" id="countriesTable">
                        <?php $counter = 1; while ($row = pg_fetch_assoc($countries)) {
                        ?>
                ...
                <div class="data">
                    ...
                    <div class="table" id="directorsTable">
                        <?php $counter = 1; while ($row = pg_fetch_assoc($directors)) {
                        ?>
                            <div class="row" data-id="<?= $row['id'] ?>">
                                <div>
                                    <span class="counter"><?= $counter ?>. </span>
                ...
                <div class="data">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <h4>Жанры (<?= pg_num_rows($countries) ?>)</h4>
                        <button onclick="addRow(this)">
                            <img src="../media/plus.svg" alt="" />
                        </button>
                    </div>
                    ...
                    <div class="table" id="genresTable">
                        <?php $counter = 1; while ($row = pg_fetch_assoc($genres)) {
